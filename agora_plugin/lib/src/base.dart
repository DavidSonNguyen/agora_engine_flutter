...
class EngineParams {
  ...
  /// See standard bitRate here https://docs.agora.io/en/Voice/API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_video_encoder_configuration.html#a4b090cd0e9f6d98bcf89cb1c4c2066e8
  /// default is 140
  final int bitRate;
  ...
  String toString() {
    ...
    return '''{\"che.video.lowBitRateStreamParameter\":{\"width\":$width,\"height\":$height,\"frameRate\":$rate,\"bitRate\":${bitRate ?? 140}}''';
  }

  factory EngineParams.defaultValue() {
    return EngineParams(
      width: 320,
      height: 180,
    );
